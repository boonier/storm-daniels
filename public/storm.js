// Adapted from modified #Codevember storm and Mr.Doobs Marching Cubes
// https://codepen.io/davidlyons/pen/KyXvjp?editors=0010
//https://cdn.rawgit.com/mrdoob/three.js/r89/examples/js/MarchingCubes.js
...
scene.background = new THREE.Color( 0x3f3c45);
...
var Rain = function() {
	...
	var pointCount = this.pointCount = 250; // 1800
	var rangeV = this.rangeV = 2.5; // 600
	var rangeH = this.rangeH = 6;
...
function loop() {
	...
	// 	scene.background.setHSL( bg.h, bg.s, bgL + 0.2 );
	// } else {
	// 	pLight.intensity = 0;
	...
	if (makeLightning) {
		pLight.intensity = 0.4;
		scene.background.setHSL( bg.h, bg.s, bgL + 0.12 );
